...
import CustomDevSpecificDetails from './CustomDevSpecificDetails'
import { Controller, useFormContext } from 'react-hook-form'
import { CommonFormType } from 'src/interfaces/forms.interface'
import { useAuth } from 'src/hooks/useAuth'
import { UserRole } from 'src/shared/enums/UserRole.enum'

const CustomDevForm = (props: any) => {
  const { update } = props
        ...
        <CardHeader
          title={
            <Typography variant='h5' color={'primary'}>
              {update ? 'Update Ticket' : ' Generate New Ticket For Custom Development'}
            </Typography>
          }
        />

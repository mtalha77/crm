...
import RemainingPriceDueDateTicketsColumns from './columns/RemainingPriceDueTicketsColumns'

function RemainingPriceDateDueTicketsTable({ data, isLoading }: any) {
  const { user } = useAuth()
  ...
  const columns: any = useMemo(
    () => RemainingPriceDueDateTicketsColumns(user, handleTicketEdit, ViewPaymentHistory),
    [data]
  )
...
export default RemainingPriceDateDueTicketsTable

...
const TeamLeadNavigation = () => {
  ...
  const navItems: VerticalNavItemsType = [
    ...
    // Only show "Create Ticket" if user is a Team Lead and not belongs to Designer or Writer department
    ...(user?.role === UserRole.TEAM_LEAD &&
      user?.department_name !== Department.Designer &&
      user?.department_name !== Department.Writer
      ? [
        {
          title: 'Create Ticket',

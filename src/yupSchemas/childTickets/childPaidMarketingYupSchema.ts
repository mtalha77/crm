import { ChildPaidMarketingFormType } from 'src/interfaces/childTicketForms.interface'
import * as yup from 'yup'

export const ChildPaidMarketingYupSchema: yup.ObjectSchema<ChildPaidMarketingFormType> = yup.object().shape({
